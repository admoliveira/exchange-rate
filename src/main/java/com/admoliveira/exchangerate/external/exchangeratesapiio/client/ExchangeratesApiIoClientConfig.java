...
@Configuration
@EnableConfigurationProperties(ExchangeratesApiIoClientConfigProperties.class)
public class ExchangeratesApiIoClientConfig {

    @Bean
    public ExchangeratesApiIoClient exchangeratesApiIoClient(
            final ExchangeratesApiIoClientConfigProperties configProperties) {
        ...
        return factory.createClient(ExchangeratesApiIoClient.class);
    }
}
